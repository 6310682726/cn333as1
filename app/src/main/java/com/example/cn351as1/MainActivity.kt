...
import com.example.cn351as1.ui.theme.Cn351as1Theme
        ...
        setContent {
            Cn351as1Theme {
                ...
                Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
                    GuessLayout( "Number Guessing Game", "Try to guess")
                }
            }
        }
    }
...
fun GuessPreview() {
    Cn351as1Theme {
        GuessLayout( stringResource(R.string.title),
            stringResource(R.string.signature_text))
    }
}

@Composable
fun GuessLayout(message: String, from: String, modifier: Modifier = Modifier) {
